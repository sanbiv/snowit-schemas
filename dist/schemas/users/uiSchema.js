...
exports.default = (formData, { jsonSchema }) => {
    return {
        ...
        'ui:layout': [
            ...
            {
                _: {
                    render: props => (<semantic_ui_react_1.Header size="small" icon="map" content="Indirizzo"/>),
                },
            },
            {
                city: { width: 10 },
            ...
            {
                _: {
                    render: props => (<semantic_ui_react_1.Header size="small" icon="settings" content="Opzioni"/>),
                },
            },
            {
            ...
            {
                _: {
                    render: props => (<semantic_ui_react_1.Header size="small" icon="eye" content="Consensi"/>),
                },
            },
            {
            ...
            {
                _: {
                    render: props => (<semantic_ui_react_1.Header size="small" icon="mobile alternate" content="Opzioni app"/>),
                },
            },
            {
